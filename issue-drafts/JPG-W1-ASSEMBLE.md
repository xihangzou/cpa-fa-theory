<!-- learning-plan:cpa-fa-theory-jpg-md-20260905:JPG-W1-ASSEMBLE -->
# Goal
Aggregate the approved section-task shards and mechanically assemble only 財務会計論短答対策問題集　理論1 into clean per-chapter and per-book Markdown.
...
# Dependencies
- https://github.com/xihangzou/cpa-fa-theory/issues/189
- https://github.com/xihangzou/cpa-fa-theory/issues/190
- https://github.com/xihangzou/cpa-fa-theory/issues/191
- https://github.com/xihangzou/cpa-fa-theory/issues/192
- https://github.com/xihangzou/cpa-fa-theory/issues/193
- https://github.com/xihangzou/cpa-fa-theory/issues/194
...
- project/W1/sources.json, batches.json, fragments/, chunks/, reviews/, qa/chapters/
- Accepted helper and contracts/HELPER_COMPATIBILITY.md from JPG-000

# Owned paths
- project/W1/tasks.json
- project/W1/merged/
- project/W1/qa/assembly.json

# Outputs
- project/W1/tasks.json
- project/W1/merged/textbook.md
- project/W1/merged/chapter-*.md
- project/W1/merged/assembly.json
- project/W1/qa/assembly.json
...
# Verification
- python3 workflow/scripts/source_md.py check project/W1 -> exit 0; every semantic gate also independently verified
- python3 workflow/scripts/source_md.py assemble project/W1 -> exit 0; rerun and compare SHA-256 -> unchanged
