<!-- learning-plan:cpa-fa-theory-jpg-md-20260905:JPG-T1-ASSEMBLE -->
# Goal
Aggregate the approved section-task shards and mechanically assemble only 財務会計論テキスト　理論1 into clean per-chapter and per-book Markdown.
...
# Dependencies
- https://github.com/xihangzou/cpa-fa-theory/issues/160
- https://github.com/xihangzou/cpa-fa-theory/issues/161
- https://github.com/xihangzou/cpa-fa-theory/issues/162
- https://github.com/xihangzou/cpa-fa-theory/issues/163
- https://github.com/xihangzou/cpa-fa-theory/issues/164
- https://github.com/xihangzou/cpa-fa-theory/issues/165
- https://github.com/xihangzou/cpa-fa-theory/issues/166
- https://github.com/xihangzou/cpa-fa-theory/issues/167
- https://github.com/xihangzou/cpa-fa-theory/issues/168
- https://github.com/xihangzou/cpa-fa-theory/issues/169
...
- project/T1/sources.json, batches.json, fragments/, chunks/, reviews/, qa/chapters/
- Accepted helper and contracts/HELPER_COMPATIBILITY.md from JPG-000

# Owned paths
- project/T1/tasks.json
- project/T1/merged/
- project/T1/qa/assembly.json

# Outputs
- project/T1/tasks.json
- project/T1/merged/textbook.md
- project/T1/merged/chapter-*.md
- project/T1/merged/assembly.json
- project/T1/qa/assembly.json
...
# Verification
- python3 workflow/scripts/source_md.py check project/T1 -> exit 0; every semantic gate also independently verified
- python3 workflow/scripts/source_md.py assemble project/T1 -> exit 0; rerun and compare SHA-256 -> unchanged
