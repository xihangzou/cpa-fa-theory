<!-- learning-plan:cpa-fa-theory-jpg-md-20260905:JPG-CS-ASSEMBLE -->
# Goal
Aggregate the approved section-task shards and mechanically assemble only 財務会計論コンパクトサマリー　短答論点総まとめテキスト　理論 into clean per-chapter and per-book Markdown.
...
# Dependencies
- https://github.com/xihangzou/cpa-fa-theory/issues/205
- https://github.com/xihangzou/cpa-fa-theory/issues/206
...
- https://github.com/xihangzou/cpa-fa-theory/issues/223
- https://github.com/xihangzou/cpa-fa-theory/issues/208
- https://github.com/xihangzou/cpa-fa-theory/issues/209
- https://github.com/xihangzou/cpa-fa-theory/issues/216
...
- project/CS/sources.json, batches.json, fragments/, chunks/, reviews/, qa/chapters/
- Accepted helper and contracts/HELPER_COMPATIBILITY.md from JPG-000

# Owned paths
- project/CS/tasks.json
- project/CS/merged/
- project/CS/qa/assembly.json

# Outputs
- project/CS/tasks.json
- project/CS/merged/textbook.md
- project/CS/merged/chapter-*.md
- project/CS/merged/assembly.json
- project/CS/qa/assembly.json
...
# Verification
- python3 workflow/scripts/source_md.py check project/CS -> exit 0; every semantic gate also independently verified
- python3 workflow/scripts/source_md.py assemble project/CS -> exit 0; rerun and compare SHA-256 -> unchanged
