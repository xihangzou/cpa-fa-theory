<!-- learning-plan:cpa-fa-theory-jpg-md-20260905:JPG-T3-ASSEMBLE -->
# Goal
Aggregate the approved section-task shards and mechanically assemble only 財務会計論テキスト　理論3 into clean per-chapter and per-book Markdown.
...
# Dependencies
- https://github.com/xihangzou/cpa-fa-theory/issues/182
- https://github.com/xihangzou/cpa-fa-theory/issues/183
- https://github.com/xihangzou/cpa-fa-theory/issues/184
- https://github.com/xihangzou/cpa-fa-theory/issues/185
- https://github.com/xihangzou/cpa-fa-theory/issues/186
- https://github.com/xihangzou/cpa-fa-theory/issues/187
- https://github.com/xihangzou/cpa-fa-theory/issues/188
...
- project/T3/sources.json, batches.json, fragments/, chunks/, reviews/, qa/chapters/
- Accepted helper and contracts/HELPER_COMPATIBILITY.md from JPG-000

# Owned paths
- project/T3/tasks.json
- project/T3/merged/
- project/T3/qa/assembly.json

# Outputs
- project/T3/tasks.json
- project/T3/merged/textbook.md
- project/T3/merged/chapter-*.md
- project/T3/merged/assembly.json
- project/T3/qa/assembly.json
...
# Verification
- python3 workflow/scripts/source_md.py check project/T3 -> exit 0; every semantic gate also independently verified
- python3 workflow/scripts/source_md.py assemble project/T3 -> exit 0; rerun and compare SHA-256 -> unchanged
