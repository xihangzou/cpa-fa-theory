<!-- learning-plan:cpa-fa-theory-jpg-md-20260905:JPG-T2-ASSEMBLE -->
# Goal
Aggregate the approved section-task shards and mechanically assemble only 財務会計論テキスト　理論2 into clean per-chapter and per-book Markdown.
...
# Dependencies
- https://github.com/xihangzou/cpa-fa-theory/issues/170
- https://github.com/xihangzou/cpa-fa-theory/issues/171
- https://github.com/xihangzou/cpa-fa-theory/issues/172
- https://github.com/xihangzou/cpa-fa-theory/issues/173
- https://github.com/xihangzou/cpa-fa-theory/issues/174
- https://github.com/xihangzou/cpa-fa-theory/issues/175
- https://github.com/xihangzou/cpa-fa-theory/issues/176
- https://github.com/xihangzou/cpa-fa-theory/issues/177
- https://github.com/xihangzou/cpa-fa-theory/issues/178
- https://github.com/xihangzou/cpa-fa-theory/issues/179
- https://github.com/xihangzou/cpa-fa-theory/issues/180
- https://github.com/xihangzou/cpa-fa-theory/issues/181
...
- project/T2/sources.json, batches.json, fragments/, chunks/, reviews/, qa/chapters/
- Accepted helper and contracts/HELPER_COMPATIBILITY.md from JPG-000

# Owned paths
- project/T2/tasks.json
- project/T2/merged/
- project/T2/qa/assembly.json

# Outputs
- project/T2/tasks.json
- project/T2/merged/textbook.md
- project/T2/merged/chapter-*.md
- project/T2/merged/assembly.json
- project/T2/qa/assembly.json
...
- [ ] Verify the assembled body against ordered reviewed chunk bodies after only the explicitly allowed removals; rerunning assembly must be byte-identical.

# Verification
- python3 workflow/scripts/source_md.py check project/T2 -> exit 0; every semantic gate also independently verified
- python3 workflow/scripts/source_md.py assemble project/T2 -> exit 0; rerun and compare SHA-256 -> unchanged
