...
# Goal
Verify whole-corpus completion across all five book handoffs and publish a Markdown-only delivery index after every final acceptance gate passes.
...
# Dependencies
- https://github.com/xihangzou/cpa-fa-theory/issues/217
- https://github.com/xihangzou/cpa-fa-theory/issues/218
- https://github.com/xihangzou/cpa-fa-theory/issues/219
- https://github.com/xihangzou/cpa-fa-theory/issues/220
- https://github.com/xihangzou/cpa-fa-theory/issues/221
...
- All five project/BOOK/qa/final.json records and their pinned merged/source hashes
...
# Outputs
- HANDOFF.md with five per-book links, editions, counts and reviewed commit/SHA-256
- delivery/manifest.json with five independently accepted outputs

# Acceptance criteria
- [ ] All five final approvals refer to accessible main revisions and current exact output bytes; no missing source, chapter gate or failed acceptance.
- [ ] Index five separate textbook.md files without concatenating, integrating, renumbering or deduplicating their content.
...
# Verification
- Independently recompute and compare five merged-file SHA-256 values to final QA -> all agree
...
# Evidence required
- Five output identities, source editions, exact verified revisions, aggregate chapter/page counts and remote readback results
